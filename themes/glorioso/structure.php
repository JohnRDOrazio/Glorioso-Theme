...
/* END CALCULATE STYLES FOR COLUMNS */
...
<div id="centercontentwrapper" style="clear:both;">



<!-- Column 1 start --> 

<div id="col1wrapper" style="float:left;width:<?php echo $_THEME_CFG['leftcolwidth']?>%;">
...
<div id="col2wrapper" style="float:right;width:<?php echo $_THEME_CFG['rightcolwidth']?>%;">
...
<div id="col3wrapper" style="margin-left:<?php echo $_THEME_CFG['centercolleftmarg'];?>%;width:<?php echo $_THEME_CFG['centercolwidth']?>%;">

<?php if ($_THEME_CFG['show_top_horizontal_menu']==1) { 

	echo "<div id=\"top_horizontal_menu\" class=\"fg-toolbar ui-widget-header ui-corner-all ui-helper-clearfix \" style=\"clear:both;\"><div class=\"fg-buttonset fg-buttonset-single ui-helper-clearfix fn-menu\">";
...
if ($_THEME_CFG['show_bottom_horizontal_menu']==1) {
	...
	echo "<div id=\"bottom_horizontal_menu\" class=\"fg-toolbar ui-widget-header ui-corner-all ui-helper-clearfix \" style=\"clear:both;\"><div class=\"fg-buttonset fg-buttonset-single ui-helper-clearfix fn-menu\">";
