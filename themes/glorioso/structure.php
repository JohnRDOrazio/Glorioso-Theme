...
if ($_THEME_CFG['show_bottom_horizontal_menu']==1) {
	echo "<div id=\"bottom_horizontal_menu\" class=\"fg-toolbar ui-widget-header ui-corner-all ui-helper-clearfix \" style=\"margin-top:10px;\"><div class=\"fg-buttonset fg-buttonset-single ui-helper-clearfix fn-menu\">";
	create_h_menu();
	echo "</div></div>";
}
?>
