...
$(document).ready(function(){
  $("input#associatewithold","form#usernamealreadyexists").click(function(){
      ...
      $("form#usernamealreadyexists").submit(function(){
        return checkpass("usernamealreadyexists");
      });
  });
...
<div style="margin:15px;padding:10px;border:ridge 2px LightGray;">
  <form id="linkoldaccount" name="linkoldaccount" action="index.php?spec=linkoldaccount" method="post" onsubmit="return checkpass('linkoldaccount')">
...
<div style="margin:15px;padding:10px;border:ridge 2px LightGray;">
  <form id="existandsameusername" name="existandsameusername" action="index.php?spec=existandsameusername" method="post" onsubmit="return checkpass('existandsameusername')">
  <div id="msg" style="text-align:center;color:#FF0000;"></div>
    ...
    <div style="text-align:center;"><button type="submit">COLLEGA ACCOUNT</button></div>
  </form>	
</div>
<div style="text-align:center;">
...
<?php
  ...
  elseif(isset($_GET['stato']) && $_GET['stato'] == 'revoke' ){
    ...
    echo "<form id=\"revoke\" name=\"revoke\" method='POST' action=\"index.php?spec=deleteaccount\" onsubmit=\"return checkpass('revoke')\">";
